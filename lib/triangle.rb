class Triangle
  ...
  def initialize(side_one, side_two, side_three)
    ...
    def kind
      ...
      if @side_one + @side_two < @side_three || @side_three + @side_two < @side_one
        raise TriangleError
      end
      ...
      if @side_one == @side_two && @side_two == @side_three && @side_three == @side_one
        ...
        :isosceles
      # else @side_one == 0 && @side_two == 0 && @side_three == 0 || @side_one + @side_two < @side_three || @side_three + @side_two < @side_one || @side_three + @side_one < @side_two
      #   raise TriangleError
      # rescue
    end
  end
